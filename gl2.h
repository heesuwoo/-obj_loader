// 이 헤더 파일을 응용 프로그램에 포함하려면 
// OpenGL 렌더링 컨텍스트가 생성되고 활성화되면 GL2Init() 함수를 호출하십시오.
